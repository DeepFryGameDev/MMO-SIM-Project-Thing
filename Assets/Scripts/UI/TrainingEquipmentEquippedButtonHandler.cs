...
public class TrainingEquipmentEquippedButtonHandler : MonoBehaviour
{
    ...
    public void OnClick()
    {
        ...
        if (MenuProcessingHandler.i.GetHeroCommandHomeMenuState() != EnumHandler.HeroCommandHomeMenuStates.TRAININGEQUIPLIST)
        {
            ...
            // open the list menu
            MenuProcessingHandler.i.SetHeroCommandHomeMenuState(EnumHandler.HeroCommandHomeMenuStates.TRAININGEQUIPLIST);
        }
    }
}
