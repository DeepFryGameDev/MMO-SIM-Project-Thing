...
public class ThirdPersonCam : MonoBehaviour
{
    ...
    public Transform playerParent; // The transform of the [Player] object in the hierarchy (public for testing)
    public void SetPlayerParent(Transform playerParent) { this.playerParent = playerParent; }

    public Transform playerObj; // Used with Vector3.slerp to move the camera's view with the player's view direction (public for testing)
